...
# Virtualbox
RUN cd /etc/yum.repos.d && wget http://download.virtualbox.org/virtualbox/rpm/rhel/virtualbox.repo && yum --enablerepo=epel install dkms && yum install VirtualBox-5.1
